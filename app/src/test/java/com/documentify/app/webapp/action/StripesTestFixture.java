package com.documentify.app.webapp.action;
...
public class StripesTestFixture {
    ...
    public void init() {
        ...
        filterParams.put("ActionResolver.Class", "com.documentify.app.webapp.action.ActionResolver");
        filterParams.put("ActionResolver.Packages", "com.documentify.app.webapp");
